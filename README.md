...
- `week2_queries_baseline.sql` – original queries
- `week2_indexes.sql` – indexes i added
- `week2_queries_optimized.sql` – cleaned up versions of the queries
- `week2_duckdb.sql` – csv vs parquet commands
